...
function Page() {
  return (
      ...
      >
        ...
        >
          <h1 className="text-4xl font-bold font-mono mb-10 text-white">Kelompok 3</h1>
          <h2 className="text-2xl text-white font-bold font-mono">XI RPL 4</h2>
        </motion.div>

        {/* Tombol dengan animasi */}
        <motion.div
          className="space-x-4 z-10" // z-10 untuk memastikan tombol di atas overlay
          initial={{ opacity: 0, y: 50 }} // Animasi awal
          animate={{ opacity: 1, y: 0 }} // Animasi saat muncul
        ...
        >
          <Link href="/kalkulator-bangun-datar">
            <motion.button
              ...
              className="w-48 bg-blue-500 text-white text-center py-2 px-4 rounded-lg font-bold hover:bg-blue-600 transition duration-300"
            >
